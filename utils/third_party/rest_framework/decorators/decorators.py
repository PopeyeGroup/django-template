...
def permissions(permission_classes: typing.Iterable) \
        -> typing.Callable:
    def wrapper_of_wrapper(function: typing.Callable) \
            -> typing.Callable:
        def default_wrapper(self, request: django_http.HttpRequest,
                            *args, **kwargs) \
                -> typing.Callable:
            ...
            return function(self, request=request,
                            *args, **kwargs)
...
def change_output(serializer: typing.Callable,
                  on_methods: typing.Iterable) \
        -> typing.Callable:
    def wrapper_of_wrapper(function: typing.Callable) \
            -> typing.Callable:
        def default_wrapper(self, instance: typing.Any,
                            *args, **kwargs) \
                -> typing.Callable:
            ...
            if any(method in on_methods for method in methods):
                return function(self, instance=instance,
                                *args, **kwargs)
            output_serializer = \
...
def make_translatable(function: typing.Callable) \
        -> typing.Callable:
    def default_wrapper(self, request: django_http.HttpRequest,
                        *args, **kwargs) \
            -> typing.Callable:
        # * Find out current thread language from request
        language = django_utils.translation \
            .get_language_from_request(request=request,
                                       check_path=True)
